...
public class GUI {
    ...
    public void vytvorHlavneMenu(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(1), "sk/uniza/fri/Obrazky/rsz_lich-4275895_1280.png");
    ...
    public void vytvorMeno(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(3), "sk/uniza/fri/Obrazky/rsz_old-books-436498_1280.png");
    ...
    public void vyberPovolaniaScreen(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(4), "sk/uniza/fri/Obrazky/rsz_1rsz_2rsz_helmet-4222117_1280.png");
    ...
    public void les(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(12), "sk/uniza/fri/Obrazky/rsz_avenue-815297_1280.png");

        this.tlacidla.add(5, new JButton());
        this.tlacidla.get(5).setBounds(440, 30, 95, 137);
        this.nastavButtonObrazok(this.tlacidla.get(5), "sk/uniza/fri/Obrazky/arrowUP.png", manazerTlacidiel);

        this.tlacidla.add(6, new JButton());
        this.tlacidla.get(6).setBounds(350, 250, 242, 208);
        this.nastavButtonObrazok(this.tlacidla.get(6), "sk/uniza/fri/Obrazky/goblin-removebg-preview.png", manazerTlacidiel);
    ...
    public void hlbokoVLese(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(13), "sk/uniza/fri/Obrazky/pine-forest-1504687_1280.png");

        this.tlacidla.add(7, new JButton());
        this.tlacidla.get(7).setBounds(450, 450, 242, 208);
        this.nastavButtonObrazok(this.tlacidla.get(7), "sk/uniza/fri/Obrazky/2141920-middle.png", manazerTlacidiel);

        this.tlacidla.add(8, new JButton());
        this.tlacidla.get(8).setBounds(240, 430, 125, 101);
        this.nastavButtonObrazok(this.tlacidla.get(8), "sk/uniza/fri/Obrazky/arrowLeft.png", manazerTlacidiel);

        this.tlacidla.add(9, new JButton());
        this.tlacidla.get(9).setBounds(640, 430, 124, 102);
        this.nastavButtonObrazok(this.tlacidla.get(9), "sk/uniza/fri/Obrazky/arrowRight.png", manazerTlacidiel);
    ...
    public void chodDozaduGUI(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavButtonObrazok(this.tlacidla.get(21), "sk/uniza/fri/Obrazky/arrowDown.png", manazerTlacidiel);
        this.panely.get(6).add(this.tlacidla.get(21));

        this.tlacidla.add(22, new JButton());
        this.tlacidla.get(22).setBounds(440, 30, 95, 137);
        this.nastavButtonObrazok(this.tlacidla.get(22), "sk/uniza/fri/Obrazky/arrowUP.png", manazerTlacidiel);
        this.panely.get(5).add(this.tlacidla.get(22));

        this.tlacidla.add(23, new JButton());
        this.tlacidla.get(23).setBounds(760, 530, 125, 101);
        this.nastavButtonObrazok(this.tlacidla.get(23), "sk/uniza/fri/Obrazky/arrowRight.png", manazerTlacidiel);
        this.panely.get(8).add(this.tlacidla.get(23));

        this.tlacidla.add(24, new JButton());
        this.tlacidla.get(24).setBounds(240, 430, 125, 101);
        this.nastavButtonObrazok(this.tlacidla.get(24), "sk/uniza/fri/Obrazky/arrowLeft.png", manazerTlacidiel);
    ...
    public void predJaskynou(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(15), "sk/uniza/fri/Obrazky/rsz_bird-stove-cave-249818_1280.png");

        this.tlacidla.add(16, new JButton());
        this.tlacidla.get(16).setBounds(50, 440, 800, 250);
        this.nastavButtonObrazok(this.tlacidla.get(16), "sk/uniza/fri/Obrazky/268-2686120_world-of-final-fantasy-cerberus-png-download-cerberus_v2.png", manazerTlacidiel);

        this.tlacidla.add(17, new JButton());
        this.tlacidla.get(17).setBounds(440, 430, 124, 102);
        this.nastavButtonObrazok(this.tlacidla.get(17), "sk/uniza/fri/Obrazky/arrowRight.png", manazerTlacidiel);
    ...
    public void vJaskyni(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(16), "sk/uniza/fri/Obrazky/ff75b44c6de7b0708bd19dbb0952af98.png");

        this.tlacidla.add(18, new JButton());
        this.tlacidla.get(18).setBounds(300, 70, 286, 528);
        this.nastavButtonObrazok(this.tlacidla.get(18), "sk/uniza/fri/Obrazky/lich-removebg-preview.png", manazerTlacidiel);
    ...
    public void lukaSObchodnikom(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(19), "sk/uniza/fri/Obrazky/rsz_field-5429112_1280.png");
        this.tlacidla.add(25, new JButton());
        this.tlacidla.get(25).setBounds(300, 70, 517, 482);
        this.nastavButtonObrazok(this.tlacidla.get(25), "sk/uniza/fri/Obrazky/52-522692_hut-clipart-peasant-house-peasant-house-clip-art-removebg-preview.png", manazerTlacidiel);
        this.panely.get(12).add(this.tlacidla.get(25));
        this.tlacidla.add(26, new JButton());
        this.tlacidla.get(26).setBounds(1, 230, 125, 101);
        this.nastavButtonObrazok(this.tlacidla.get(26), "sk/uniza/fri/Obrazky/arrowLeft.png", manazerTlacidiel);
    ...
    public void menuObchodnik(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(20), "sk/uniza/fri/Obrazky/rsz_background.png");
    ...
    public void smrtScreen(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(17), "sk/uniza/fri/Obrazky/rsz_ff8d0940719aee05e0cc22ea890e8b01.png");
    ...
    public void vyhraScreen(ManazerTlacidiel manazerTlacidiel) {
        ...
        this.nastavPozadieLabel(this.labely.get(18), "sk/uniza/fri/Obrazky/rsz_2dpcgri.png");
    ...
    private void nastavLabelObrazok(JLabel label) {
        ImageIcon obrazok = new ImageIcon(Objects.requireNonNull(this.getClass().getClassLoader().getResource("sk/uniza/fri/Obrazky/HUD.png")));
